...
const Product = ({product}) => {
  ...
  return (
    <div>
      <div className='border border-[#e4e4e4] h-[300px] mb-4 relative overflow-hidden
      group transition' >
        ...
        group-hover:opacity-100 transition-all duration-300'>
          ...
          <NavLink to={`/product/${id}`} className='w-12 h-12 bg-white flex justify-center items-center
